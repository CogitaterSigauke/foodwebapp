...
* Setup Google Authentication and copy your client ID
...
* open foodweb_backend/pom.xml and make sure you have the right version of azure: Version should be 1.9.0
...
# Deploy your Application(Frontend)
