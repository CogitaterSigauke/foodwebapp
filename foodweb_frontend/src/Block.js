                ...
                <div style={{ display: 'flex' }}>
                    ...
                    <center>
                        <div style={{ background: 'white' }}>
                            ...
                            <br></br>
                            <Link to="/Components/ProfileComponents/Profile">
                                <div><button class="Box" type="button">About Me</button></div>
                            </Link>
                            <br></br>
                            <Link to="/Components/ProfileComponents/MyFavorites">
                                <div><button class="Box" type="button">My Favorites</button></div>
                            </Link>
                            <br></br>
                            <Link to="/Components/ProfileComponents/Recipe">
                    ...
                    <div class="parent">
                        ...
                        {/* <header>
                                <div className="input-group">
                                    < SearchBox translations={{ placeholder: 'Search for User' }} />
                                </div>
                            </header> */}
