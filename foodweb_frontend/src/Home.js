...
//   <div>
//     <Hits hitComponent={ProfileHit} />
//   </div>

// const ProfileHit = ({ hit }) =>
// // but itdid't wor
//   <div>
//     <div className="hit col-lg-4 col-md-6 mb-4">
//       <div className="card border-0 shadow">
//         <Link to={`/user/${hit.objectID}`}><img src={hit.imageString} className="card-img-top" alt="..." /></Link>
//         <div className="card-body text-center">
//           <h4 className="card-title">
                  ...
                  <ul className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item dropdown no-arrow">
                      ...
                      <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                        {/* pass the user Id then get it in your profile page */}
